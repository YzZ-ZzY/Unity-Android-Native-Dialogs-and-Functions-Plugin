...
namespace FantomLib
{
    ...
    public static class AndroidPlugin
    {
        ...
        public static void CheckPermissionAndRequest(string permission, string title, string message,
            AndroidPermissionCallback callback, string style = "")
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
            AndroidJavaClass androidSystem = new AndroidJavaClass(ANDROID_SYSTEM);
        ...
        //新增对话框接口
        //cancelable 点击对话框区域外时是否退出
        public static void ShowDialog(string title, string message, AndroidDialogCallback callback,
            string yesCaption, string noCaption, bool cancelable = true, string style = "")
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
            AndroidJavaClass androidSystem = new AndroidJavaClass(ANDROID_SYSTEM);
        ...
        //cancelable 点击对话框区域外时是否退出
        public static void ShowDialog(string title, string message, AndroidDialogCallback callback,
            string okCaption, bool cancelable = true, string style = "")
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
            AndroidJavaClass androidSystem = new AndroidJavaClass(ANDROID_SYSTEM);
        ...
        public static void ShowSingleChoiceDialog(string title, string[] items, int checkedItem, AndroidSingleChoiceDialogCallback callback,
            bool resultIsIndex, string okCaption = "OK", string cancelCaption = "Cancel", string style = "")
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
        ...
        public static void ShowSliderDialog(string title, string message, string[] items, string[] itemKeys,
            float[] defValues, float[] minValues, float[] maxValues, int[] digits, int itemsTextColor,
            AndroidCustomDialogCallback callback,
            string okCaption = "OK", string cancelCaption = "Cancel", string style = "")
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
        ...
        public static void ShowNumericTextDialog(string title, string message, float defValue, int maxLength, bool enableDecimal, bool enableSign,
            AndroidNumericTextDialogCallback callback, string okCaption = "OK", string cancelCaption = "Cancel", string style = "")
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
            AndroidJavaClass androidSystem = new AndroidJavaClass(ANDROID_SYSTEM);
        ...
        //新增对话框接口
        public static void ShowDatePickerDialog(string defaultDate, string resultDateFormat, AndroidDatePickerDialogCallback callback,
             string style = "")
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
       ...
       public static void PrintPdfDoc(string filePath)
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
            AndroidJavaClass androidSystem = new AndroidJavaClass(ANDROID_SYSTEM);
        ...
        public static void WordToHtml(string sourcerFile, string targetFile)
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
            AndroidJavaClass androidSystem = new AndroidJavaClass(ANDROID_SYSTEM);
        ...
        public static void PrintHtmlDoc(string htmlPath)
        {
            AndroidJavaClass unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
            AndroidJavaObject context = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
            AndroidJavaClass androidSystem = new AndroidJavaClass(ANDROID_SYSTEM);
