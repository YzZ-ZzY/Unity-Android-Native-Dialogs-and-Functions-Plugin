...
namespace FantomLib
{
    public class AndroidDatePickerDialogCallback : AndroidJavaProxy
    {
        ...
        public AndroidDatePickerDialogCallback(ResultCallback resultCallback) : base(AndroidPlugin.ANDROID_PACKAGE + ".AndroidDatePickerDialogCallback") { 
